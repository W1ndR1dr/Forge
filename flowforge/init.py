"""
Enhanced project initialization for FlowForge.
...
class ProjectContext:
    ...
    def to_markdown(self) -> str:
        ...
        sections = [
            ...
            "",
            "This file is auto-generated by FlowForge and feeds into all implementation prompts.",
            "",
        ]
    ...
    def save(self, project_root: Path) -> Path:
        """Save project context to .flowforge/project-context.md."""
...
class EnhancedInitializer:
    ...
    def run(self, interactive: bool = True) -> ProjectContext:
        ...
        console.print(Panel(
            "[bold]FlowForge Enhanced Initialization[/bold]\n\n"
