"""
Pi-Local Registry Storage for Forge.

This module manages registry files locally on the Raspberry Pi at:
    /var/forge/registries/{project}/registry.json
...
class PiRegistryManager:
    ...
    the Mac's .forge/registry.json format exactly.
    """
    ...
    def __init__(self, base_path: Optional[Path] = None):
        ...
        Args:
            base_path: Base directory for registries. Defaults to
                       FORGE_REGISTRY_PATH or /var/forge/registries
        """
    ...
    def get_config(self, project_name: str) -> Optional[ForgeConfig]:
        """
        ...
        Returns:
            ForgeConfig or None if not found
        """
    ...
    def save_config(self, project_name: str, config: ForgeConfig, mac_path: str) -> None:
        """
        Save a project's config to Pi-local storage.

        Args:
            project_name: Name of the project
            config: ForgeConfig to save
