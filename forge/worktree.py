...
class WorktreeManager:
    ...
    Each feature gets its own worktree in .forge-worktrees/{feature-id}/,
    allowing multiple Claude Code sessions to work on different features
    simultaneously without branch switching conflicts.
    """

    def __init__(self, repo_root: Path, worktree_base: str = ".forge-worktrees"):
    ...
    def create_for_feature(
        ...
        2. Creates worktree at: .forge-worktrees/{feature_id}
