# FlowForgeApp - macOS SwiftUI Application

A native macOS app for FlowForge that provides a visual Kanban board interface for managing features.
...
- Xcode 15.0+
- XcodeGen
- FlowForge CLI (`forge` command in PATH)
...
1. The app automatically discovers FlowForge projects in:
   - `~/Projects/Active`
   - `~/Projects`
   - `~/Developer`
...
- No offline mode - requires valid FlowForge projects
