# Implement: Brainstorm Mode

## Feature
Claude chat integration with product strategist system prompt. Uses --append-system-prompt to create a special brainstorming session. When user is satisfied, Claude outputs READY_FOR_APPROVAL marker with structured JSON proposals.

**Tags:** cli, claude, brainstorm
